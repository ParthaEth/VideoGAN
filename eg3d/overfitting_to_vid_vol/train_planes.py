...
if __name__ == '__main__':
    ...
    appearance_feat = 33 if network_pkl is None else G.appearance_feat
    ...
    if target_resolution > rendering_res:
        superresolution = SuperresolutionHybrid4X(channels=32, img_resolution=target_resolution,
    ...
    for i in pbar:
        ...
        if i % 200 == 0 and not args.disable_progressbar:
            ...
            rgb_img_test, _, _, = renderer(feature_grid[:len(cond)], decoder, cond, None,
