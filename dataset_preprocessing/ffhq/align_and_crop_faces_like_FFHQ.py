...
def get_my_file_list(pid, tot_ps, src_dir):
    ...
    idx_intervals = list(range(0, len(all_files), tot_ps))
...
if __name__ == '__main__':
    ...
    if args.align:
        for img_name in tqdm.tqdm(get_my_file_list(args.src)):
        ...
        for img_name in tqdm.tqdm(get_my_file_list(aligned_img_path)):
